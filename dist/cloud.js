 ...
 */
export async function syncSnapshot(snapshot, projectPath, config) {
 ...
 */
export async function bulkSyncSnapshots(snapshots, config) {
    const cfg = config || getCloudConfig();
    if (!cfg.enabled || !cfg.apiKey) {
 ...
 */
export async function checkCloudHealth(config) {
    const cfg = config || getCloudConfig();
    try {
